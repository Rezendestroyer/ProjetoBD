...
namespace Projeto_Estacionamento
{
    public partial class CadastroEntradaSaida : Form
    {
        ...
        private void bt_EntSaidConsultar_Click(object sender, EventArgs e)
        {
            ...
            List<EntradaSaidaDocument> docs = comandos.consultarEntradasSaidas();

            dg_EntSaidConsulta.Rows.Clear();

            docs.ForEach(doc =>
            {
                dg_EntSaidConsulta.Rows.Add(doc.cpf, doc.placa, doc.acao, doc.hora, doc.data);
            });
        }
        ...
        private void cadastrar()
        {
            ...
            try
            {
                ...
                docs.ForEach(doc =>
                {
                    cb_EntSaidCliente.Items.Add(doc.cpf);
                });
            }
            catch (Exception excep)
            {
